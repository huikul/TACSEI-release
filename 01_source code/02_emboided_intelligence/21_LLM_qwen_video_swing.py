...
def main():
    dir_video = home_dir + '/dataSSD/tamser_video/resize/480/swing_bottle_counterclock.mp4'
    ...
    PROMPT_MESSAGES = [
        ...
        {   "role": "user",
            "content": output_text[0][0:50] + doc_task,
        },
    ]
    params = {
        "model": "gpt-4o",
    ...
    dir_new = dir_save_data + "/21_LLM_qwen_swing_time{}".format(str(str_time))
