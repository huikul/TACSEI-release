...
def resize_clip_video(input_path, output_path, width, height, flg_clip=False, target_duration=5.5):
    ...
    original_duration = resized_clip.duration

    # If the video is longer than 5.5 seconds, accelerate it
    if flg_clip is True and original_duration > target_duration:
        speed_factor = original_duration / target_duration
        resized_clip = resized_clip.fx(lambda clip: clip.speedx(factor=speed_factor))
