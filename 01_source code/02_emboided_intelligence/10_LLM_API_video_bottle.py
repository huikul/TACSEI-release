...
def main():
    dir_video = home_dir + '/dataSSD/tamser_video/rh_close.mp4'
    ...
    print(doc_hardware)
    file_path = 'prompts/06_task_video_bottle_cap.txt'
    ...
    dir_new = dir_save_data + "/10_LLM_API_time{}".format(str(str_time))
